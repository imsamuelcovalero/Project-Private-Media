...
const errorMiddleware = (err, _req, res, _next) => {
  if (err.isBoom) {
    /* Se for um erro do boom, você pode acessar as propriedades específicas do boom com err.output */
    const boomError = err;
    ...
    /* Se não for um erro do boom, você pode tratar como um erro genérico do Node.js */
